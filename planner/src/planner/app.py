...
from client.sandbox_manager_client import ECSSandboxManager, LocalSandboxManager
from services.planner import Planner

LoggerManager.initialize()
logger = LoggerManager.get_logger()

# Use LocalSandboxManager for local deployment without remote ECS
# Change to ECSSandboxManager() if you need remote sandbox support
...
async def handle_task(sandbox_id, task_id, model_name,
    ...
    sandbox_endpoint = sandbox_manager.get_tool_server_endpoint(sandbox_id)
